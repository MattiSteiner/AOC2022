	...
	match line[0]:
		case 'R':
			for i in range(int(line[2])):
				...
				coordHinatesS[coordT[0]][coordT[1]] = 'X'
...
#	print("coordHinats: ",coordH, line)

#print(coordHinatesS)
print(coordH,coordT)

print(coordHinatesS[coordT[0]][coordT[1]])
print("Tot fields: ",sum(i == 'X' for i in sum(coordHinatesS,[])))
print(coordHinatesS)
